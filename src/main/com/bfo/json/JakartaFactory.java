...
class JakartaFactory implements JsonParserFactory, JsonReaderFactory, JsonBuilderFactory, JsonWriterFactory, JsonGeneratorFactory {

    private final Map<String,?> config;
    private boolean pretty;

    JakartaFactory(Map<String,?> config) {
    ...
    @Override public JsonParser createParser(InputStream in) {
        return new JakartaJsonParser(new JsonReader(), in);
    }
    ...
    @Override public jakarta.json.JsonReader createReader(InputStream in) {
        return new JakartaJsonReader(createParser(in));
    }

    @Override public jakarta.json.JsonReader createReader(InputStream in, Charset charset) {
        return new JakartaJsonReader(createParser(in, charset));
    }

    @Override public jakarta.json.JsonReader createReader(Reader reader) {
        return new JakartaJsonReader(createParser(reader));
    }
    ...
    @Override public JsonArrayBuilder createArrayBuilder() {
        return new JakartaJsonArrayBuilder();
    }

    @Override public JsonArrayBuilder createArrayBuilder(Collection<?> collection) {
        JsonArrayBuilder builder = new JakartaJsonArrayBuilder();
    ...
    @Override public JsonObjectBuilder createObjectBuilder() {
        return new JakartaJsonObjectBuilder();
    }

    @Override public JsonObjectBuilder createObjectBuilder(Map<String,Object> object) {
        JsonObjectBuilder builder = new JakartaJsonObjectBuilder();
        Set<Object> seen = new HashSet<Object>();
    ...
    @Override public jakarta.json.JsonWriter createWriter(OutputStream out, Charset charset) {
    ...
    @Override public jakarta.json.JsonWriter createWriter(Writer writer) {
        ...
        return new JakartaJsonGenerator(w, writer).asWriter();
    }
    ...
    @Override public JsonGenerator createGenerator(Writer writer) {
        ...
        w.setOutput(WriterToAppendable.getInstance(writer));
        w.setIndent(pretty ? 2 : 0);
        return new JakartaJsonGenerator(w, writer);
    }
    ...
    private static class JakartaJsonArrayBuilder implements JsonArrayBuilder {
        ...
        @Override public JsonArrayBuilder add(int index, JsonArrayBuilder value) {
            ...
            return add(index, ((JakartaJsonArrayBuilder)value).build());
        }
        @Override public JsonArrayBuilder add(int index, JsonObjectBuilder value) {
            if (value == null) {
                throw new NullPointerException("Value is null");
            }
            return add(index, ((JakartaJsonObjectBuilder)value).build());
        }
    ...
    private static class JakartaJsonObjectBuilder implements JsonObjectBuilder {
        ...
        @Override public JsonObject build() {
            return new JakartaJsonObject(m);
        }
    }
    ...
    static JsonValue toJsonValue(Object o, Set<Object> seen) {
        ...
        if (o instanceof JsonValue) {
            ...
            return new JakartaJsonNumber((Number)o);
        } else if (o instanceof String) {
            return new JakartaJsonString((String)o);
            ...
            return new JakartaJsonArray(list);
            ...
            return new JakartaJsonObject(map);
        } else {
