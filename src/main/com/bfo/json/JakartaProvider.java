 ...
 * </p>
 */
public class JakartaProvider extends JsonProvider {
    ...
    @Override public JsonBuilderFactory createBuilderFactory(Map<String,?> config) {
        return new JakartaFactory(config);
    }
    ...
    @Override public jakarta.json.JsonReader createReader(InputStream in) {
        return createReaderFactory(null).createReader(in);
    }
    @Override public jakarta.json.JsonReader createReader(Reader reader) {
    ...
    @Override public JsonNumber createValue(double value) {
        return new JakartaJsonNumber(value);
    }
    ...
    @Override public JsonString createValue(String value) {
        return new JakartaJsonString(value);
    }
    ...
    @Override public jakarta.json.JsonWriter createWriter(OutputStream out) {
        return createWriterFactory(null).createWriter(out);
    }
    @Override public jakarta.json.JsonWriter createWriter(Writer writer) {
    ...
    @Override public JsonPointer createPointer(String jsonPointer) {
        return new JakartaJsonPointer(jsonPointer);
    }
    ...
    @Override public JsonArrayBuilder createArrayBuilder(Collection<?> collection) {
        ...
        for (Object o : collection) {
            JsonValue val = JakartaFactory.toJsonValue(o, seen);
            if (val != null) {
                b.add( val);
            }
        }
    ...
    @Override public JsonObjectBuilder createObjectBuilder(Map<String,?> map) {
        ...
        for (Map.Entry<String,?> e : map.entrySet()) {
            String key = e.getKey();
            JsonValue val = JakartaFactory.toJsonValue(e.getValue(), seen);
            if (val != null) {
                b.add(key, val);
            }
        }
...
//        System.out.println("DONE");
    ...
    @Override public JsonMergePatch createMergeDiff(JsonValue source, JsonValue target) {
        return new JakartaJsonMergePatch(JakartaJsonMergePatch.build(source, target));
    }

    @Override public JsonMergePatch createMergePatch(JsonValue patch) {
        return new JakartaJsonMergePatch(patch);
    }

    @Override public JsonPatchBuilder createPatchBuilder() {
        return new JakartaJsonPatchBuilder();
    }

    @Override public JsonPatchBuilder createPatchBuilder(JsonArray array) {
        JakartaJsonPatchBuilder b = new JakartaJsonPatchBuilder();
    ...
    private static class JakartaJsonPatchBuilder implements JsonPatchBuilder {
        private List<JsonValue> a = new ArrayList<JsonValue>();
        private JakartaJsonPatchBuilder op(Object... o) {
            LinkedHashMap<String,JsonValue> m = new LinkedHashMap<String,JsonValue>();
            m.put("op", new JakartaJsonString((String)o[0]));
            for (int i=1;i<o.length;) {
                m.put((String)o[i++], (JsonValue)o[i++]);
            }
            add(new JakartaJsonObject(m));
            return this;
        }
        ...
        @Override public JsonPatchBuilder add(String path, boolean value) {
            return op("add", "path", new JakartaJsonString(path), "value", value == true ? JsonValue.TRUE : JsonValue.FALSE);
        }
        @Override public JsonPatchBuilder add(String path, int value) {
            return op("add", "path", new JakartaJsonString(path), "value", new JakartaJsonNumber(value));
        }
        @Override public JsonPatchBuilder add(String path, String value) {
            return op("add", "path", new JakartaJsonString(path), "value", new JakartaJsonString(value));
        }
        @Override public JsonPatchBuilder add(String path, JsonValue value) {
            return op("add", "path", new JakartaJsonString(path), "value", value);
        }
        @Override public JsonPatchBuilder copy(String path, String from) {
            return op("copy", "path", new JakartaJsonString(path), "from", new JakartaJsonString(from));
        }
        @Override public JsonPatchBuilder move(String path, String from) {
            return op("move", "path", new JakartaJsonString(path), "from", new JakartaJsonString(from));
        }
        @Override public JsonPatchBuilder remove(String path) {
            return op("remove", "path", new JakartaJsonString(path));
        }
        @Override public JsonPatchBuilder replace(String path, boolean value) {
            return op("replace", "path", new JakartaJsonString(path), "value", value == true ? JsonValue.TRUE : JsonValue.FALSE);
        }
        @Override public JsonPatchBuilder replace(String path, int value) {
            return op("replace", "path", new JakartaJsonString(path), "value", new JakartaJsonNumber(value));
        }
        @Override public JsonPatchBuilder replace(String path, String value) {
            return op("replace", "path", new JakartaJsonString(path), "value", new JakartaJsonString(value));
        }
        @Override public JsonPatchBuilder replace(String path, JsonValue value) {
            return op("replace", "path", new JakartaJsonString(path), "value", value);
        }
        @Override public JsonPatchBuilder test(String path, boolean value) {
            return op("test", "path", new JakartaJsonString(path), "value", value == true ? JsonValue.TRUE : JsonValue.FALSE);
        }
        @Override public JsonPatchBuilder test(String path, int value) {
            return op("test", "path", new JakartaJsonString(path), "value", new JakartaJsonNumber(value));
        }
        @Override public JsonPatchBuilder test(String path, String value) {
            return op("test", "path", new JakartaJsonString(path), "value", new JakartaJsonString(value));
        }
        @Override public JsonPatchBuilder test(String path, JsonValue value) {
            return op("test", "path", new JakartaJsonString(path), "value", value);
        }
        @Override public JsonPatch build() {
            return new JakartaJsonArray(a);
        }
    }
    ...
    Object get(Object value) {
        if (value == JsonValue.TRUE) {
            ...
            return ((JakartaJsonNumber)value).numberValue();
        } else if (value instanceof JsonNumber) {
            return ((JakartaJsonNumber)value).bigDecimalValue();
        } else if (value instanceof JsonString) {
            return ((JakartaJsonString)value).getString();
        } else {
            return value;
        }
    }
...
//        System.out.println("GD2: p="+path+" s="+source+" t="+target+" i="+i+" j="+j+" lut="+dump(lut)+" = "+lut[i][j]);
    ...
    static class DiffGenerator {
        ...
        JsonArray diff(JsonStructure source, JsonStructure target) {
            builder = jakarta.json.Json.createPatchBuilder();
            diff("", source, target);
